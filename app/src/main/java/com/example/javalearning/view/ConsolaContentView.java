...
public class ConsolaContentView extends LinearLayout {

	private TextView mTextView;
	
	public ConsolaContentView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initView(context);
	}

	public ConsolaContentView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}

	public ConsolaContentView(Context context) {
		super(context);
		initView(context);
	}
	...
	private void initView(Context context) {
		...
		view.setBackgroundColor(res.getColor(R.color.color_orange));
		
		addView(view);
		
		mTextView = new ConsolaTextView(context);
